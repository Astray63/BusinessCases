...
-- ========================================
-- Insert sample bornes (formerly charging stations)
-- ========================================
...
VALUES
((SELECT borne_id FROM borne WHERE numero = 'B001'), 'borne1_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B001'), 'borne1_2.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B002'), 'borne2_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B003'), 'borne3_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B003'), 'borne3_2.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B003'), 'borne3_3.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B004'), 'borne4_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B005'), 'borne5_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B006'), 'borne6_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B007'), 'borne7_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B008'), 'borne8_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B009'), 'borne9_1.jpg'),
((SELECT borne_id FROM borne WHERE numero = 'B010'), 'borne10_1.jpg');
