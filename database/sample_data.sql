...
VALUES
('B001', 'Borne Rivoli Paris', '123 Rue de Rivoli, 75001 Paris', '123 Rue de Rivoli, 75001 Paris', 48.8566, 2.3522, 7, 'Insérer la carte, sélectionner la puissance, brancher le câble', 'DISPONIBLE', false, 0.092, 5.52, 'Type 2', 'Borne pratique en centre-ville de Paris', 1),
('B002', 'Station Rapide Lyon', '456 Rue de la République, 69002 Lyon', '456 Rue de la République, 69002 Lyon', 45.7640, 4.8357, 50, 'Approcher votre badge, brancher le connecteur CCS', 'DISPONIBLE', false, 0.146, 8.76, 'CCS', 'Station de charge rapide avec parking couvert', 2),
('B003', 'Borne Eco Marseille', '789 La Canebière, 13001 Marseille', '789 La Canebière, 13001 Marseille', 43.2965, 5.3698, 25, 'Utiliser l''application mobile pour démarrer', 'DISPONIBLE', false, 0.071, 4.26, 'CHAdeMO', 'Borne écologique alimentée par panneaux solaires', 3),
('B004', 'Premium Toulouse', '321 Rue du Capitole, 31000 Toulouse', '321 Rue du Capitole, 31000 Toulouse', 43.6047, 1.4442, 22, 'Code d''accès: 1234, suivre les instructions à l''écran', 'DISPONIBLE', false, 0.167, 10.02, 'Type 2', 'Station premium avec salon d''attente', 4),
('B005', 'Budget Nice', '654 Promenade des Anglais, 06000 Nice', '654 Promenade des Anglais, 06000 Nice', 43.7102, 7.2620, 3, 'Paiement par carte bancaire uniquement', 'DISPONIBLE', false, 0.058, 3.48, 'Type 1', 'Option de charge économique près de la plage', 5),
('B006', 'Centre Ville Paris', '987 Avenue des Champs-Élysées, 75008 Paris', '987 Avenue des Champs-Élysées, 75008 Paris', 48.8600, 2.3500, 50, 'Accès 24h/7j, badge ou application mobile', 'DISPONIBLE', false, 0.121, 7.26, 'CCS', 'Emplacement central avec accès 24h/24', 1),
('B007', 'Centre Commercial Lyon', '741 Rue de la Part-Dieu, 69003 Lyon', '741 Rue de la Part-Dieu, 69003 Lyon', 45.7650, 4.8370, 11, 'Chargez pendant vos achats, 4h maximum', 'DISPONIBLE', false, 0.100, 6.00, 'Type 2', 'Rechargez pendant que vous faites vos courses', 2),
('B008', 'Parc Bureau Marseille', '852 Boulevard Longchamp, 13001 Marseille', '852 Boulevard Longchamp, 13001 Marseille', 43.2980, 5.3710, 25, 'Réservé employés 8h-18h, public le soir/weekend', 'DISPONIBLE', false, 0.158, 9.48, 'CHAdeMO', 'Idéal pour la recharge en entreprise', 3),
('B009', 'Résidentiel Toulouse', '963 Place Wilson, 31000 Toulouse', '963 Place Wilson, 31000 Toulouse', 43.6060, 1.4460, 7, 'Zone calme, respecter le voisinage', 'DISPONIBLE', false, 0.079, 4.74, 'Type 2', 'Emplacement résidentiel calme', 4),
('B010', 'Hôtel Nice', '159 Avenue Jean Médecin, 06000 Nice', '159 Avenue Jean Médecin, 06000 Nice', 43.7120, 7.2640, 50, 'Disponible pour clients hôtel et public', 'DISPONIBLE', false, 0.133, 7.98, 'CCS', 'Disponible pour les clients de l''hôtel et le public', 5);
